...
MINECRAFT_STATUS_CHECK_PROTOCOL_MAGIC_VERSION_VALUE_LEGACY: int = -1
MINECRAFT_STATUS_CHECK_TRIES: int = 1
MINECRAFT_ENTRIES_NAMES_SEPARATOR: str = ','
MINECRAFT_EMPTINESS_MONITOR_STATUS_TIMEOUT_S: float | None = 10
MINECRAFT_EMPTINESS_MONITOR_NOTIFY_EMPTY_TIMEOUT_S: float | None = 10
MINECRAFT_EMPTINESS_MONITOR_NOTIFY_NOT_EMPTY_TIMEOUT_S: float | None = 10
...
ENV_KEY_MINECRAFT_INSTANCE_ENTRY_PREFIX_STATUS_CHECK_HOST: str = "minecraft_instance_entry_status_check_host_"
ENV_KEY_MINECRAFT_INSTANCE_ENTRY_PREFIX_STATUS_CHECK_PORT: str = "minecraft_instance_entry_status_check_port_"
ENV_KEY_MINECRAFT_INSTANCE_ENTRY_PREFIX_STATUS_CHECK_PROTOCOL_VERSION: str = "minecraft_instance_entry_status_check_protocol_version_"
