...
if BLAKE2_USE_SSE:
    sourcesB = [
        os.path.join(_libdir, "blake2b.c"),
    ]
    sourcesS = [
        os.path.join(_libdir, "blake2s.c"),
    ]
else:
    sourcesB = [
        os.path.join(_libdir, "blake2b-ref.c"),
    ]
    sourcesS = [
        os.path.join(_libdir, "blake2s-ref.c"),
    ]
...
def _replace_b2s(src):
    for b, s in (("blake2b", "blake2s"), ("BLAKE2B", "BLAKE2S")):
        src = src.replace(b, s)
    return src
